...
public class TutorPermissionEvaluator implements PermissionEvaluator {
    ...
    public boolean hasPermission(Authentication authentication, Object targetDomainObject, Object permission) {
        ...
        if (targetDomainObject instanceof Integer) {
            ...
            switch (permissionValue) {
                ...
                case "CLARIFICATION_REQUEST_ANSWER.ACCESS":
                    return userCreatedClarificationRequestAnswer(userId, id);
                case "COURSE.ACCESS":
                ...
                case "QUESTION_ANSWER.ACCESS":
                    return userHasAnswered(userId, id);
                case "TOPIC.ACCESS":
                ...
                case "QUESTION_SUGGESTION.ACCESS":
                    return userHasAnExecutionOfTheCourse(userId, questionSuggestionService.findQuestionSuggestionCourse(id).getCourseId());
    ...
    private boolean userCreatedClarificationRequestAnswer(int userId, int id) {
        return userService.getClarificationRequestAnswers(userId).stream()
                .anyMatch(clarificationRequestAnswer -> clarificationRequestAnswer.getId() == id);
    }
