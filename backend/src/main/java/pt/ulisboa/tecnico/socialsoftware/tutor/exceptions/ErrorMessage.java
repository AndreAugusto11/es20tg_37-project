...
public enum ErrorMessage {
    ...
    INVALID_AVAILABLE_DATE_FOR_TOURNAMENT("Invalid available date for tournament"),
    INVALID_CONCLUSION_DATE_FOR_TOURNAMENT("Invalid conclusion date for tournament"),
    ...
    TOURNAMENT_ENROLLMENTS_NO_LONGER_AVAILABLE("This tournament is no longer available for enrollment"),
    TOPIC_CONJUNCTION_IS_USED_IN_TOURNAMENT("Topic conjunctions of this assessment are used in tournament %s"),
    TOURNAMENT_NULL_USER("User ID is not defined"),
    INVALID_TITLE_FOR_TOURNAMENT("Invalid title for tournament"),
    INVALID_NULL_ARGUMENTS_TOURNAMENT_DTO("Tournament is null"),
    TOURNAMENT_HAS_NO_TOPICS("Tournament has no topics"),
    ...
    COURSE_EXECUTION_TOURNAMENT_MISMATCH("Course Execution %d does not have tournament %d"),
    ...
    INVALID_NUMBER_OF_QUESTIONS("Number of questions must be superior to zero"),
    ...
    INVALID_NULL_ARGUMENTS_SUGGESTION_ID("The question suggestion id given is null"),
    INVALID_NULL_ARGUMENTS_USER_ID("The user id given is null"),
    INVALID_NULL_ARGUMENTS_USER("The given user is null"),
    INVALID_NULL_ARGUMENTS_COURSE_ID("The course id given is null"),
    ...
    INVALID_NULL_ARGUMENTS_QUESTION_ID("The question id given is null"),
    INVALID_NULL_ARGUMENTS_ANSWER_DTO("The answer given is null"),
