...
class AcceptQuestionSuggestionTest extends Specification {
    ...
    def "The question suggestion exists and a teacher accepts it"() {
        // The question becomes available
        expect: false
    }

    def "The question suggestion exists and a teacher from a different course accepts it"() {
        // An exception is thrown
        expect: false
    }

    def "The question suggestion exists and a student accepts it"() {
        // An exception is thrown
        expect: false
    }
